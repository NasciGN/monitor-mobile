...
import 'package:monitor_mobile/src/views/incidents/components/trigger_severity_card.dart';
                  ...
                  child: Row(
                    children: [
                      Row(
                        children: [
                          TriggerSeverityCard(
                              color: getSeverityColors('5')["bgColor"],
                              severity: '5',
                              isFirst: true,
                              isLast: false,
                              selectedSeverity: selectedSeverity,
                              onTap: (String severity) {
                                setState(() {
                                  selectedSeverity = severity;
                                });
                              }),
                          TriggerSeverityCard(
                              color: getSeverityColors('4')["bgColor"],
                              severity: '4',
                              isFirst: false,
                              isLast: false,
                              selectedSeverity: selectedSeverity,
                          ...
                          TriggerSeverityCard(
                              color: getSeverityColors('3')["bgColor"],
                              severity: '3',
                              isFirst: false,
                              isLast: false,
                              selectedSeverity: selectedSeverity,
                          ...
                          TriggerSeverityCard(
                              color: getSeverityColors('2')["bgColor"],
                              severity: '2',
                              isFirst: false,
                              isLast: false,
                              selectedSeverity: selectedSeverity,
                          ...
                          TriggerSeverityCard(
                              color: getSeverityColors('1')["bgColor"],
                              severity: '1',
                              isFirst: false,
                              isLast: false,
                              selectedSeverity: selectedSeverity,
                          ...
                          TriggerSeverityCard(
                              color: getSeverityColors('0')["bgColor"],
                              severity: '0',
                              isFirst: true,
                              isLast: true,
                              selectedSeverity: selectedSeverity,
