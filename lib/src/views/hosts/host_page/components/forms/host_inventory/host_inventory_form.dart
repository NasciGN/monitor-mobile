...
import 'package:monitor_mobile/src/views/hosts/host_page/components/forms/host_inventory/form/form.dart';
...
class HostInventoryForm extends StatelessWidget {
  ...
  bool _isInventoryEmpty(Host host) {
    final inventory = host.inventory;
    if (inventory == null) return true;

    // Verifica se todos os campos do inventário estão vazios ou nulos
    return inventory.toJson().values.every(
  ...
  Widget build(BuildContext context) {
    final isEmpty = _isInventoryEmpty(host);
      ...
      child: Padding(
        ...
        child: isEmpty
            ...
            : Column(children: [
                ...
                CustomInventorySerialnoAForm(
                    serialnoA: host.inventory!.serialnoA),
                CustomInventorySerialnoBForm(
                    serialnoB: host.inventory!.serialnoB),
                ...
                CustomInventoryHostRouterForm(
                    hostRouter: host.inventory!.hostRouter),
                CustomInventoryOobIpForm(oobIp: host.inventory!.oobIp),
                CustomInventoryOobNetmaskForm(
                    oobNetmask: host.inventory!.oobNetmask),
                CustomInventoryOobRouterForm(
                    oobRouter: host.inventory!.oobRouter),
                ...
                CustomInventorySiteStateForm(
                    siteState: host.inventory!.siteState),
                ...
                CustomInventorySiteNotesForm(
                    siteNotes: host.inventory!.siteNotes),
