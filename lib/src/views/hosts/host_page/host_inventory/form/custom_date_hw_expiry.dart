...
class CustomInventoryDateHwExpiryForm extends StatefulWidget {
  const CustomInventoryDateHwExpiryForm(
      {super.key, required this.dateHwExpiry});
  final String dateHwExpiry;

  @override
  State<CustomInventoryDateHwExpiryForm> createState() =>
      _CustomInventoryDateHwExpiryFormState();
}

class _CustomInventoryDateHwExpiryFormState
    extends State<CustomInventoryDateHwExpiryForm> {
