...
class CustomInventoryInstallerNameForm extends StatefulWidget {
  const CustomInventoryInstallerNameForm(
      {super.key, required this.installerName});
  final String installerName;

  @override
  State<CustomInventoryInstallerNameForm> createState() =>
      _CustomInventoryInstallerNameFormState();
}

class _CustomInventoryInstallerNameFormState
    extends State<CustomInventoryInstallerNameForm> {
