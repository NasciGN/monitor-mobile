...
class CustomInventoryPoc2Notes2notesForm extends StatefulWidget {
  const CustomInventoryPoc2Notes2notesForm(
      {super.key, required this.poc_2Notes});
  final String poc_2Notes;

  @override
  State<CustomInventoryPoc2Notes2notesForm> createState() =>
      _CustomInventoryPoc2Notes2notesFormState();
}

class _CustomInventoryPoc2Notes2notesFormState
    extends State<CustomInventoryPoc2Notes2notesForm> {
