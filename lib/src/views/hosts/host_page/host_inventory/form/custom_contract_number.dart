...
class CustomInventoryContractNumberForm extends StatefulWidget {
  const CustomInventoryContractNumberForm({super.key, required this.contractNumber});
  final String contractNumber;

  @override
  State<CustomInventoryContractNumberForm> createState() => _CustomInventoryContractNumberFormState();
}

class _CustomInventoryContractNumberFormState extends State<CustomInventoryContractNumberForm> {
