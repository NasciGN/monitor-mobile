...
class CustomInventorySiteAddressCForm extends StatefulWidget {
  const CustomInventorySiteAddressCForm({super.key, required this.siteAddressC});
  final String siteAddressC;

  @override
  State<CustomInventorySiteAddressCForm> createState() => _CustomInventorySiteAddressCFormState();
}

class _CustomInventorySiteAddressCFormState extends State<CustomInventorySiteAddressCForm> {
