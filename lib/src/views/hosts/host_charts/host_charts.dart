...
class HostCharts extends StatefulWidget {
  const HostCharts({super.key});

  @override
  State<HostCharts> createState() => _HostChartsState();
}

class _HostChartsState extends State<HostCharts> {
  String hostId = Get.arguments;
  ChartDataController hostGraphDataController = ChartDataController();
  ...
  Future<void> fetchHostCharts() async {
    if (mounted) {
      setState(() {
        _isLoading = true;
      });
