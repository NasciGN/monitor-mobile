...
class CustomInventorySiteCityForm extends StatefulWidget {
  ...
  @override
  State<CustomInventorySiteCityForm> createState() =>
      _CustomInventorySiteCityFormState();
}

class _CustomInventorySiteCityFormState
    extends State<CustomInventorySiteCityForm> {
