...
class CustomInventoryDateHwPurchaseForm extends StatefulWidget {
  const CustomInventoryDateHwPurchaseForm(
      {super.key, required this.dateHwPurchase});
  final String dateHwPurchase;

  @override
  State<CustomInventoryDateHwPurchaseForm> createState() =>
      _CustomInventoryDateHwPurchaseFormState();
}

class _CustomInventoryDateHwPurchaseFormState
    extends State<CustomInventoryDateHwPurchaseForm> {
